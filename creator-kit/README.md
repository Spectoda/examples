...
artifact under the matching `creator-kit-v0.1.0` GitHub Release in
`Spectoda/examples`.
...
`Spectoda/documentation@67827bf5d2680de8bbb7a3a7e73773441669cbf3`; the
example is locked to
`Spectoda/examples@97fd90afbc9839830b3dc7f73df36f385f66564d`. The firmware
